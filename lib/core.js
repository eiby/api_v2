...
exports._getID = getNewID;

// 执行command
// command: 指令
exports._executeCommand = function (command, callback) {
...
// is_exists_update: 如果存在是否更新数据
// update_json: 更新的数据
exports._create2 = function (table_name, table_schema, unique_id, create_json, is_judge_exists, exists_query, exists_fields,
                            is_exists_update, update_query, update_json, callback) {
    var m_table = mongoose.model(table_name, table_schema);
    if(is_judge_exists){
        m_table.findOne(exists_query, exists_fields, function(err, data){
...
exports._update = function (table_name, table_schema, unique_id, query_json, update_json, callback) {
    ...
    var m_table = mongoose.model(table_name, table_schema);
    m_table.update(query_json, {"$set": update_json}, { multi: true }, function (err, row, raw) {
        if(row > 0){
            callback(define.DB_STATUS_OK);
        }else{
            callback(define.DB_STATUS_FAIL);
...
// query_json: 更新条件
// update_json: 更新的数据
exports._update2 = function (table_name, table_schema, unique_id, query_json, update_json, callback) {
    var update_time = new Date();
    update_json.update_time = update_time;
    var m_table = mongoose.model(table_name, table_schema);
    m_table.update(query_json, update_json, { multi: true }, function (err, row, raw) {
        if(row > 0){
            callback(define.DB_STATUS_OK);
        }else{
            callback(define.DB_STATUS_FAIL);
...
// query_json: 更新条件
// update_json: 更新的数据
exports._findAndUpdate2 = function (table_name, table_schema, unique_id, query_json, update_json, callback) {
    var m_table = mongoose.model(table_name, table_schema);
    m_table.findOneAndUpdate(query_json, update_json, {'upsert': true}, function (err, doc) {
        if(err){
            callback(define.DB_STATUS_FAIL);
        }else{
            callback(define.DB_STATUS_OK, doc);
