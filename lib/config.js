    ...
    development: {
        ...
        router: {
            ...
            map: {
                ...
                'wicare.user.vehicles.list': '/customer/vehicles/list',
                'wicare.user.vehicles.search': '/customer/vehicles/search',
                'wicare.comm.sms.send': '/comm/sms/send',
                'wicare.vehicle.update': '/vehicle/update',
                'wicare.business.total.month': '/business/total/month',
                'wicare.business.total.day': '/business/total/day',
