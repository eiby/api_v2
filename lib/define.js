...
exports.API_STATUS_INVALID_VALIDCODE = 0x9006;  //无效的验证码
exports.API_STATUS_INVALID_PARAM = 0x9007;      //无效的参数
exports.API_STATUS_COMMAND_TIMEOUT = 0x9008;    //指令发送超时
exports.API_STATUS_NO_SELLER_RIGHT = 0x9009;    //没有商户权限
exports.API_STATUS_INVALID_WEIXIN_APPSECRET = 0x900A;  //无效的微信AppSecret
